...
# renovate: datasource=docker depName=actions-runner-controller/actions-runner-controller/actions-runner
ARG BASE_VERSION=v2.304.0-ubuntu-20.04
...
### Final image
FROM actions-runner-controller/actions-runner-controller/actions-runner:${BASE_VERSION} as final
